        	...
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                	<div class="text-center mb-4">
                        <h2 class="h2">Team design and codding website Effective</h2>
                        <div class="rte-setting">
                            <p><strong>Shop - fashion and beauty.</strong></p>
                            <p>The have the staff support profession and frienly , here we provide for customer interesting expriences.</p>
                        </div>
                    </div>
               	</div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <ul class="addressFooter">
                        <li><i class="icon anm anm-map-marker-al"></i><p>273 An D. Vương, Phường 3, Quận 5, Thành phố Hồ Chí Minh</p></li>
                        <li class="phone"><i class="icon anm anm-phone-s"></i><p>091761399</p></li>
                        <li class="email"><i class="icon anm anm-envelope-l"></i><p>nta02052001@gmail.com</p></li>
                    </ul>
                    <hr />
